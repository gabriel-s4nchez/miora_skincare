import 'node:fs';
import { e as appendForwardSlash, j as joinPaths, t as trimSlashes, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, f as collapseDuplicateSlashes } from './chunks/astro/assets-service_PS6zEpf4.mjs';
import { serialize, parse } from 'cookie';
import { A as AstroError, R as ResponseSentError, l as MiddlewareNoDataOrNextCalled, n as MiddlewareNotAResponse, G as GetStaticPathsRequired, o as InvalidGetStaticPathsReturn, p as InvalidGetStaticPathsEntry, q as GetStaticPathsExpectedParams, t as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, N as NoMatchingStaticPathFound, u as PrerenderDynamicEndpointPathCollide, v as LocalsNotAnObject, w as ASTRO_VERSION, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, x as renderEndpoint, y as ReservedSlotName, z as renderSlotToString, B as renderJSX, D as chunkToString, F as CantRenderPage, H as renderPage$1 } from './chunks/astro_kQPa56tw.mjs';
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_uRsGz0cG.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const _page0  = () => import('./chunks/generic_Km1Zkj6j.mjs');
const _page1  = () => import('./chunks/create_vWp__7Dp.mjs');
const _page2  = () => import('./chunks/_id__GQDcv8Aq.mjs');
const _page3  = () => import('./chunks/_product__vnwwXTnh.mjs');
const _page4  = () => import('./chunks/cart_YErgAUQp.mjs');
const _page5  = () => import('./chunks/checkout_isJWRVif.mjs');
const _page6  = () => import('./chunks/index_G55XHNKy.mjs');const pageMap = new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0],["src/pages/order/create.ts", _page1],["src/pages/order/[id].astro", _page2],["src/pages/shop/[product].astro", _page3],["src/pages/cart.astro", _page4],["src/pages/checkout.astro", _page5],["src/pages/index.astro", _page6]]);
